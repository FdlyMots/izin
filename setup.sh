...
# REPO    
    ...
    No2vpn="https://raw.githubusercontent.com/FdlyMots/izin/main/menu2.zip"
...
print_install "Menginstall ePro WebSocket Proxy"
    ...
    wget -O /usr/bin/sysctl.conf "${REPO}ws/sysctl.conf" >/dev/null 2>&1
...
echo -e  "${REDBG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a log-install.txt
echo -e  "${REDBG}🔔 INFORMATION AUTHOR SCRIP🔔     ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a log-install.txt
#echo -e  ""
echo -e  "${REDBG}┌──────• INFO AUTHOR SC •──────┐${NC}" | tee -a log-install.txt
echo -e  "${REDBG}│⏰ 📢 AUTHOR     : MyridTunnel  ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}│❌ ✅ RECODE      : ALL-SC      ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}│❌ ✅ DESCRIPTION : SSH & XRAY  ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}│❌ ✅ TELEGRAM    : T.me/kytxz  ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}│❌ ✅ WHATSAPP    : 081774970898${NC}" | tee -a log-install.txt
echo -e  "${REDBG}└──────────────────────────────┘${NC}" | tee -a log-install.txt
#echo ""
echo -e  "${REDBG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a log-install.txt
echo -e  "${REDBG}  🔰 JANGAN LUPA SHALAT ! 🔰      ${NC}" | tee -a log-install.txt
echo -e  "${REDBG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a log-install.txt
echo -e ""
echo ""
...
echo -e "${REDBG}┌────────────────────────────────────────────┐${NC}"
echo -e "${REDBG}│  Install SCRIPT SELESAI..                  │${NC}"
echo -e "${REDBG}└────────────────────────────────────────────┘${NC}"
echo  ""
sleep 1
echo ""
