...
# REPO    
    ...
    NotNot2="https://raw.githubusercontent.com/kytrx/v3/main/"
...
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "${NotNot2}ws/ws" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "${NotNot2}ws/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "${NotNot2}ws/ws.service" >/dev/null 2>&1
